...
import { startCampanhasJob } from './modules/whatsapp/campanha.service.js';
...
async function start() {
  ...
  try {
    ...
    // Inicia o loop de Campanhas do WhatsApp
    startCampanhasJob();
    console.log('[Worker] Job de Campanhas agendado e rodando (intervalo: 60s).');
  } catch (error) {

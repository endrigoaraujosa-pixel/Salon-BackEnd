...
userRoutes.get('/', protect, requirePermission('usuarios.visualizar'), listUsers);
...
configRoutes.get('/whatsapp', protect, requirePermission(['configuracoes.whatsapp', 'agenda.whatsapp_historico']), getWhatsappConfig);
configRoutes.post('/whatsapp', protect, requirePermission('configuracoes.whatsapp'), saveWhatsappConfig);
